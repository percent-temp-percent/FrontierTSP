...
nuke-component-announcement-armed = Внимание! Механизм самоуничтожения центрального аванпоста был активирован { $location }. До детонации { $time } секунд.
nuke-component-announcement-unarmed = Механизм самоуничтожение центрального аванпоста деактивирован! Хорошего дня!
